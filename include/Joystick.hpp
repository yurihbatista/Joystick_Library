...
class Joystick
{
    private:
        ...
        unsigned pressDelayX();
        unsigned pressDelayY();
        int last_X, last_Y;
        int pressCountX, pressCountY;
    ...
    public:
        ...
        bool Y_asButtonUp();
        bool Y_asButtonDown();
        bool X_asButtonRight();
        bool X_asButtonLeft();

        bool Y_asButtonUpDebounced();
        bool Y_asButtonDownDebounced();
        bool X_asButtonRightDebounced();
        bool X_asButtonLeftDebounced();
